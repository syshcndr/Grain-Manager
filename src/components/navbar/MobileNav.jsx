                ...
                <FocusLock disabled={!show} returnFocus>
                    ...
                    >
                        <Box pt="5" pb="6" px="5">
                            ...
                            >
                                <NavLink.Mobile icon={HiCloudDownload}>Home</NavLink.Mobile>
                                <NavLink.Mobile icon={HiCurrencyDollar}>About</NavLink.Mobile>
                                <NavLink.Mobile icon={HiBookOpen}>Download App</NavLink.Mobile>
